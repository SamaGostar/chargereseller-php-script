...
<body>
	<div class="bgs">
		...
		<div class="container verify" style="display:block!important;">
			...
			?>
						<div id="left">
							<img src="/img/bill-success.png" class="success">
			...
			?>
						<div id="left">
							<img src="/img/topup-success.png" class="success">
				...
				?>
						<div id="left">
							<img src="/img/<?php echo strtolower(substr($result['PinProductKind'], 0, 2)) . '-success.png'; ?>" class="success">
